...
@mcp.tool()
def get_method_signature(class_name: str, method_name: str) -> dict:
    """
    Returns the full signature of a method including return type and parameters.
    """
    return invoke_jadx("get_method_signature", {
        "class_name": class_name,
        "method_name": method_name
    })
...
@mcp.tool()
def get_field_details(class_name: str, field_name: str) -> dict:
    """
    Returns detailed information about a field including type and modifiers.
    """
    return invoke_jadx("get_field_details", {
        "class_name": class_name,
...
@mcp.tool()
def search_method_by_return_type(return_type: str) -> list:
    """
    Search methods by their return type.
    """
    return invoke_jadx("search_method_by_return_type", {
...
def get_class_hierarchy(class_name: str) -> dict:
    """
    Returns the inheritance hierarchy of a class.
    """
    return invoke_jadx("get_class_hierarchy", {
        "class_name": class_name
    })


@mcp.tool()
def get_method_calls(class_name: str, method_name: str) -> list:
    """
    Returns all method calls made within a specific method.
    """
    return invoke_jadx("get_method_calls", {
        "class_name": class_name,
        "method_name": method_name
    })
...
@mcp.tool()
def get_class_references(class_name: str) -> list:
    """
    Returns all references to a specific class in the codebase.
    """
    return invoke_jadx("get_class_references", {
        "class_name": class_name
    })


@mcp.tool()
def get_method_annotations(class_name: str, method_name: str) -> list:
    """
    Returns all annotations on a specific method.
    """
    return invoke_jadx("get_method_annotations", {
        "class_name": class_name,
        "method_name": method_name
    })
